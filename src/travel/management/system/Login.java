...
public class Login extends JFrame implements ActionListener{
	...
	panel.setLayout(null);//when u want to create ur own layout or frame set the setlayout null
	...
	JLabel l3 = new JLabel("");//jlabel to write the text on frame
	...
	panel.add(l5);
        ...
        JPanel panel2 = new JPanel();//to divide the frame 
